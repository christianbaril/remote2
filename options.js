    ...
    my.options =
        {
            ...
            addServer: function () {
                ...
                $('#entry_host').val('https://rt.wickedsun.org/');
                $('#entry_client').val('rutorrent');
                $('#label_selection').val('At runtime');
                $('#directory_selection').val('None');
                $('#entry_host').attr('disabled', true);
                $('#entry_client').attr('disabled', true);
                $('#label_selection').attr('disabled', true);
                $('#directory_selection').attr('disabled', true);
